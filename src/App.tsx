...
function OrientationOverlay() {
  ...
  useEffect(() => {
    const checkOrientation = () => {
      ...
      setIsPortrait(isMobile && !isHorizontal);
    };
    checkOrientation();
    ...
    <>
      ...
      <HashRouter>
        <Routes>
          <Route
            path="/"
            element={<MainSite themeId={themeId} setThemeId={setThemeId} />}
          />
          <Route
            path="/admin"
            element={
              <AdminDashboard themeId={themeId} setThemeId={setThemeId} />
            }
          />
