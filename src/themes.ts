...
export const themes: Theme[] = [
  ...
  },
  {
    ...
    colors: {
      ...
      '--color-bg2': '#080600',
      '--color-bg3': '#1c1500',
      '--color-glass-bg': 'rgba(20, 15, 0, 0.95)',
      '--color-glass-border': 'rgba(255, 215, 0, 0.65)',
      '--color-card-grad': 'radial-gradient(circle at top right, rgba(255, 215, 0, 0.35), rgba(255, 215, 0, 0) 50%), linear-gradient(135deg, rgba(30, 25, 0, 0.98), rgba(10, 8, 0, 0.98))',
      '--color-glow-1': 'rgba(255, 215, 0, 0.45)',
      '--color-glow-2': 'rgba(255, 170, 0, 0.35)',
    },
  },
  {
    id: 'casino-sport',
